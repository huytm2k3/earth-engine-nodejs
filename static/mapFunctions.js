const addLayer = (mapId, token) => {
    ...
    //         const baseUrl = 'https://earthengine.googleapis.com/v1'
    //         const url = [baseUrl, mapId, 'tiles', zoom, tile.x, tile.y].join('/')
    //         console.log(url);
    ...
    map.addSource('wms-test-source', {
        ...
        'tiles': [
            'https://earthengine.googleapis.com/v1/' + mapId + '/tiles/{z}/{x}/{y}'
        ],
        'tileSize': 256
    });
    map.addLayer(
